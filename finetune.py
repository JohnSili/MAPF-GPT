...
if init_from == "scratch":
    ...
    # Reset for finetuning
    if 'iter_num' in checkpoint and checkpoint['iter_num'] >= 2000:
        logger.info(f"Resetting iter_num from {checkpoint['iter_num']} to 0 for fine-tuning")
...
#if init_from == "resume":
    # optimizer.load_state_dict(checkpoint["optimizer"])  # commented for fine-tuning from trimmed model
